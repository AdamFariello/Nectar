...
public class ScrapedProductVO extends JSONEncodeableValueObject{
    public String title;
    ...
    public ScrapedProductVO(String title, String productID, boolean available, double price, int amtInStock){
        this.title = title;
    ...
    public String createMessageOfProductChange(ScrapedProductVO curr) {
