...
-- Wed 03 May 2023 10:03:39 AM EDT
...
CREATE TABLE IF NOT EXISTS `nectarDB_products`.`amazonProductPriceHistoryDetails` (
  ...
  `apphd_dateAndTime` TIMESTAMP(6) NOT NULL,
...
-- -----------------------------------------------------
-- Table `nectarDB_products`.`amazonProductAvailabilityHistoryDetails`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nectarDB_products`.`amazonProductAvailabilityHistoryDetails` ;

CREATE TABLE IF NOT EXISTS `nectarDB_products`.`amazonProductAvailabilityHistoryDetails` (
...
-- -----------------------------------------------------
-- Table `nectarDB_products`.`amazonProductAvailabilityHistory`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nectarDB_products`.`amazonProductAvailabilityHistory` ;

CREATE TABLE IF NOT EXISTS `nectarDB_products`.`amazonProductAvailabilityHistory` (
  `product_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_amazonProductAvailabilityHistory_amazonProductAvailability1`
    ...
    REFERENCES `nectarDB_products`.`amazonProductAvailabilityHistoryDetails` (`apahd_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
