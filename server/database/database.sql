...
-- Mon 17 Apr 2023 09:59:12 AM EDT
...
-- -----------------------------------------------------
-- Table `nectarDB_products`.`ebayTagsDescription`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nectarDB_products`.`ebayTagsDescription` ;

CREATE TABLE IF NOT EXISTS `nectarDB_products`.`ebayTagsDescription` (
...
-- -----------------------------------------------------
-- Table `nectarDB_products`.`ebayCategoryEnum`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nectarDB_products`.`ebayCategoryEnum` ;

CREATE TABLE IF NOT EXISTS `nectarDB_products`.`ebayCategoryEnum` (
...
-- -----------------------------------------------------
-- Table `nectarDB_products`.`ebay`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nectarDB_products`.`ebay` ;

CREATE TABLE IF NOT EXISTS `nectarDB_products`.`ebay` (
  ...
  CONSTRAINT `fk_ebay_2`
    ...
    REFERENCES `nectarDB_products`.`ebayCategoryEnum` (`ece_category`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `nectarDB_products`.`ebayTags`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nectarDB_products`.`ebayTags` ;

CREATE TABLE IF NOT EXISTS `nectarDB_products`.`ebayTags` (
  `product_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_ebayTags_1`
    FOREIGN KEY (`product_id`)
    REFERENCES `nectarDB_products`.`ebay` (`product_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ebayTags_2`
    FOREIGN KEY (`ebayTagsDescription_etd_id`)
    REFERENCES `nectarDB_products`.`ebayTagsDescription` (`etd_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `nectarDB_products`.`ebayProductPriceHistoryDescription`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nectarDB_products`.`ebayProductPriceHistoryDescription` ;

CREATE TABLE IF NOT EXISTS `nectarDB_products`.`ebayProductPriceHistoryDescription` (
...
-- -----------------------------------------------------
-- Table `nectarDB_products`.`ebayProductPriceHistory`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nectarDB_products`.`ebayProductPriceHistory` ;

CREATE TABLE IF NOT EXISTS `nectarDB_products`.`ebayProductPriceHistory` (
  `product_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_ebayProductPriceHistory_2`
    ...
    REFERENCES `nectarDB_products`.`ebayProductPriceHistoryDescription` (`epphd_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
