...
-- Mon 17 Apr 2023 05:07:41 AM EDT
...
CREATE TABLE IF NOT EXISTS `nectar`.`amazon` (
  ...
  `amazon_categoryEnum` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `nectar`.`ebay` (
  ...
  `ebay_categoryEnum` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `nectar`.`ebayProductPriceHistory` (
  `ebay_siteID` VARCHAR(45) NOT NULL,
  `epph_price` DOUBLE NOT NULL,
  `epph_date` DATETIME NOT NULL,
  PRIMARY KEY (`ebay_siteID`),
...
CREATE TABLE IF NOT EXISTS `nectar`.`userWishListAutoBuySetting` (
  `uwl_AutoPurchaseID` INT NULL,
  `uwlaubs_conditionTypeEnum` VARCHAR(45) NOT NULL,
  `uwlaubs_conditionOperatorEnum` VARCHAR(45) NOT NULL COMMENT 'connditionOperatorEnum = {equals, less than, greater than, .... }',
...
CREATE TABLE IF NOT EXISTS `nectar`.`administration` (
  ...
  `admin_url` VARCHAR(45) GENERATED ALWAYS AS (CONCAT("jdbc:mysql://", admin_host, ":", admin_port, "/nectar", "verifyServerCertificate=false")),
